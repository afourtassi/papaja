\documentclass[$if(fontsize)$$fontsize$,$endif$$if(lang)$$lang$,$endif$$if(papersize)$$papersize$,$endif$$if(figsintext)$floatsintext,$endif$$if(mask)$mask,$endif$$for(class)$$class$$sep$,$endfor$]{apa6}
...
$endif$
$if(biblatex)$
\usepackage[backend=biber,style=$if(biblio-style)$$biblio-style$$else$apa$endif$,sortcites=false,sorting=none,doi,url]{biblatex}
